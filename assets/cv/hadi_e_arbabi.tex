...
\begin{etaremune}[leftmargin=0ex, topsep=0ex]
	\item Regional Studies Association (no. 15429)\\Regional Sciences Association International (no. RSAI08605)\\The OR Society (no. 031935)
\end{etaremune}
%%%
\section{Education}
\href{http://www.civil.shef.ac.uk}{The University of Sheffield}
...
\end{etaremune}
%%
\section{Recent\\Funding\\\small{(\textbf{\pounds298k} apportioned)}}
...
%	\item Gruffudd Ap Ieuan \hfill {2023 -- Present}\\\textit{A Risky Road: How Does Urban Morphology Change Cities' Risk Levels for Urban Explosions?}\label{ecrdtp}
	...
	\textit{Energy Retrofit for Commercial Buildings}
